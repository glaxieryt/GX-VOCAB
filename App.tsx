  ...
  const renderSubjectSelection = () => (
      <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-12 animate-fadeIn pb-12">
          <div className="text-center space-y-4 px-4 mb-4">
              <h2 className="text-5xl md:text-7xl font-serif font-medium tracking-tight text-black dark:text-white animate-slideUp">Master English Vocabulary</h2>
              <p className="text-zinc-500 dark:text-zinc-400 max-w-md mx-auto text-lg font-light animate-slideUp" style={{ animationDelay: '0.1s' }}>
                  Your journey to advanced vocabulary starts here.
              </p>
          </div>

          <div className="grid grid-cols-1 gap-8 w-full max-w-xl px-4 animate-slideUp" style={{ animationDelay: '0.2s' }}>
              {/* ENGLISH CARD */}
              <div 
